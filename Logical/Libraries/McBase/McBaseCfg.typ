TYPE
	...
	McMMCMcAcpDrvPLKCycPerParIDEnum :
		( (*Defines the number of POWERLINK cycles per ParID for parameter transfer by ProcessParID*)
	...
	McMMCMcAcpDrvType : STRUCT (*ACOPOS driver configuration*)
		POWERLINKCyclesPerParID : McMMCMcAcpDrvPLKCycPerParIDEnum; (*Defines the number of POWERLINK cycles per ParID for parameter transfer by ProcessParID*)
	END_STRUCT;
